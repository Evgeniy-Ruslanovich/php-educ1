...
/**
 * Created by PhpStorm.
 * Домашнее задание №1. Евгений Зайнутдинов
 * Date: 03.12.2016
 * Time: 23:37
 */
$title = 'minimalistika';
...
$b = $a + $b;  // второй переменной присваиваем сумму
$a = $b - $a;  //если из суммы вычесть первую переменную получится вторая
$b = $b - $a;  //если из суммы вычесть первую переменную, которая уже равна второй, то получится что мы получим обратно первую
