...
$tasks = [
    "0" => [
        "name" => "Привезти проекторы с Козловского",
        "category" => "work",
        "descript" => 'Нет такой задачи',
        "details" => "блафывало фывадлодофав ячьсмтджцут смячмтдуцтмчса фывалутвыма ыфавфывафыва фывфывафыва 
        фывфывафаыв фывафывав фывафывааыв фывфываыф фывафвыафыва фывафыва "
    ],
    "1" => [
